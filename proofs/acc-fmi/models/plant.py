"""Two vehicles with held-input constant-acceleration motion per FMI interval."""
...
class AccPlant(Fmi3Slave):
    def __init__(self, **kwargs):
        ...
        self.lead_accel_mps2 = LEAD_ACCEL_MPS2
        self.initial_lead_position_m = LEAD_POSITION_M
        ...
        self.register_variable(Float64("lead_accel_mps2", unit="m/s2",
                                       causality=Fmi3Causality.input))
        self.register_variable(Float64("initial_lead_position_m", unit="m",
                                       causality=Fmi3Causality.input))
    ...
    def exit_initialization_mode(self):
        self.lead_position_m = self.initial_lead_position_m
    ...
    def do_step(self, current_time, step_size):
        ...
        self.lead_position_m, self.lead_speed_mps = advance(
            self.lead_position_m, self.lead_speed_mps,
            self.lead_accel_mps2, step_size)
        return True
